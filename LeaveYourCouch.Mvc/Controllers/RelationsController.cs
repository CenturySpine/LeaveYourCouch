...
namespace LeaveYourCouch.Mvc.Controllers
{
    ...
    public class RelationsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            vm.BlackList = RelationshipHelper.GetRelations(RelationshipStatus.Blacklisted);
            vm.Friends = RelationshipHelper.GetRelations(RelationshipStatus.Accepted);
            vm.Pendings = RelationshipHelper.GetRelations(RelationshipStatus.Pending);
            return View(vm);
        }
    }
}